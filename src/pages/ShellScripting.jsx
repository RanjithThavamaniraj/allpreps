...
import { FiArrowLeft, FiTerminal, FiSearch, FiChevronDown, FiChevronUp, FiCpu, FiTrendingUp, FiCheck } from 'react-icons/fi';
...
export default function ShellScripting() {
  ...
  const shellQuestions = useMemo(() => {
    return QUESTIONS_DATA.filter(q => q.category === 'shell scripting').map(q => ({
      id: `sh-${q.id}`,
      rawId: q.id,
      title: q.title,
      difficulty: q.difficulty,
      description: q.title + ' - Scenario-based question covering Bash shell scripting, automation scripts, text manipulation, and scheduling.',
      details: q.answer,
      solution: q.command,
