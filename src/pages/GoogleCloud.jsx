...
export default function GoogleCloud() {
  ...
  const googleQuestions = useMemo(() => {
    return getQuestionsByTech('google').map(q => ({
      id: `google-${q.id}`,
      rawId: q.id,
      title: q.question,
      difficulty: q.difficulty,
      description: q.question + ' - Scenario-based question covering Google Cloud architecture, RDS databases, IAM security, VPC networks, and S3 storage.',
      details: q.answer,
      solution: q.command,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flexGrow: 1, paddingBottom: '80px' }}>
        ...
        <ProductionScenariosCallout trackId="google" />
      </main>
